import ServiceLink from "@/components/main/desktop/common/ServiceLink";
...
const ServiceLinkList = () => {
  ...
  return (
    <div className="flex flex-col flex-wrap gap-4 bg-white shadow-md p-6 max-w-80 rounded-3xl border-gray-50">
